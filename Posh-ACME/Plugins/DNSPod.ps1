...
function Add-DnsTxt {
    ...
    .EXAMPLE
        Add-DnsTxt '_acme-challenge.example.com' 'txt-value' -DNSPodCredential (Get-Credential)
    ...
    .EXAMPLE
        ...
        PS C:\>Add-DnsTxt '_acme-challenge.example.com' 'txt-value' @creds
...
function Remove-DnsTxt {
    ...
    .EXAMPLE
        Remove-DnsTxt '_acme-challenge.example.com' 'txt-value' -DNSPodCredential (Get-Credential)

        Removes a TXT record for the specified site with the specified value using a PSCredential object.

    .EXAMPLE
        $creds = @{DNSPodUsername='me@example.com';DNSPodPwdInsecure='xxxxxxxx'}
        PS C:\>Remove-DnsTxt '_acme-challenge.example.com' 'txt-value' @creds
