...
function Add-DnsTxt {
    ...
    .EXAMPLE
        Add-DnsTxt '_acme-challenge.example.com' 'txtvalue' -SdnsApiRoot http://dns.example.com:8053
...
function Remove-DnsTxt {
    ...
    .EXAMPLE
        Remove-DnsTxt '_acme-challenge.example.com' 'txtvalue' -SdnsApiRoot http://dns.example.com:8053
