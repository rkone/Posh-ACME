...
function Add-DnsTxt {
    ...
    .EXAMPLE
        Add-DnsTxt '_acme-challenge.example.com' 'txt-value' -UEAccount 'UE123456' -UEAPIKey 'key'
...
function Remove-DnsTxt {
    ...
    .EXAMPLE
        Remove-DnsTxt '_acme-challenge.example.com' 'txt-value' -UEAccount 'UE123456' -UEAPIKey 'key'
